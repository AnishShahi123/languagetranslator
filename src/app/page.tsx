...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex items-center justify-center">
      <div className="relative overflow-hidden w-full max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-24">
              ...
              <div className="relative z-10 flex flex-col border rounded-lg shadow-lg bg-neutral-900 border-neutral-700 shadow-gray-900/20">
                ...
                <div className="flex flex-row justify-between w-full">
                  <span className="cursor-pointer flex items-center space-x-2 flex-row">
                    ...
                    <IconButton
                      Icon={IconVolume}
                      onClick={() => handleAudioPlayback(targetText as string)}
                    />
                  </span>
                  <div className="flex flex-row items-center space-x-2 pr-4 cursor-pointer">
                    ...
                    <IconButton Icon={IconThumbDown} onClick={handleDislike} />
                    <IconStar
                      size={22}
